...
class NeuralNet(object):
    ...
    # The functions are defined in stacked_bidirectional.py
    ...
    # The functions below are defined in stacked_bidirectional.py
    @abstractmethod
    ...
    def _index2sentence(self, list_):
        ...
        Return an output Sentence [String]
        list_: The list of the index of the words in the output sentence (in order)
        """
        rev_map = self.mapper_dict['rev_map']  
        # rev_map is reverse mapping from index in vocabulary to actual word
        sentence = ""
        for entry in list_:
            if entry != 0:
    ...
    def store_test_predictions(self, prediction_id='_final'):
        ...
        prediction_id: A simple id appended to the name of the summary for uniqueness
        """
